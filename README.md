...
- `~/.codex/skills/{agent-code-review-loop,atlas,frontend-design,gh-address-comments,gh-fix-ci,gh-manage-pr,handoff,improve-codebase-architecture,notion-knowledge-capture,notion-read,programming,spaces,sql-read,ultragoal}`
- `~/.codex/AGENTS.md`
- `~/.codex/prompts/pr.md`
