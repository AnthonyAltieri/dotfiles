...
Use a browser-automation tool for DOM inspection, visible page interaction, and logged-in web sessions. Use this skill only for Atlas-native tab operations or Atlas-local bookmarks and history.
...
Read `references/atlas-data.md` in this skill's folder when adjusting data paths or timestamps.
